...
@email_templates.route("/v1/email-templates/<int:email_template_id>", methods=['GET', 'PUT', 'DELETE'])
def RUD_email_template(email_template_id):
...
@email_templates.route("/v1/email-templates", methods=['GET', 'POST'])
def email_template():
    ...
    #Api thêm mới mẫu email
        ...
        if result1 == None:
            ...
            return jsonify({
                "code": 200,
                "user_message": "Tiêu đề mẫu email của bạn đã tồn tại, vui lòng đạt tiêu đề khác!",
                "internal_message": "Request thành công"
            })
